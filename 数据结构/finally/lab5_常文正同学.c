...
//给定ID，输出根节点到这个节点的路径,初始level设为0,path存左右孩子指针标记，-1表示左孩子，1表示右孩子
...
int main()
{
	...
	int id1 = 7, id2 = 9;
	printf("\n测试二叉树%d和%d的LCA:%d", val[id1], val[id2], FindLCA(t1, id1, id2)); //测试求两个节点的最近公共祖先

	printf("\n测试二叉树最大数值差:%d", ValueMax(t1)); //测试二叉树最大数值差
